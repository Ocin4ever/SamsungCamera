...
.field private mViewBinding:Lp4/h0;
...
.method public static synthetic c(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    .locals 0
...
.method public static synthetic d(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic e(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V
    .locals 0
...
.method public static synthetic f(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$startQuickViewTranslationAnimation$15(Landroid/graphics/Bitmap;Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V

    return-void
.end method

.method public static synthetic g(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/view/View;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$initialize$4(Landroid/view/View;)V

    return-void
.end method

.method private getScaleDownAnimator()Landroid/animation/ObjectAnimator;
    .locals 11
    ...
    invoke-direct {v2, v3, v4, v1, v8}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V

    invoke-virtual {v0, v2}, Landroid/animation/Animator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$5;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$5;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method public static synthetic h(Landroid/view/View;Landroid/view/View;Landroid/animation/ValueAnimator;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$updateButton$9(Landroid/view/View;Landroid/view/View;Landroid/animation/ValueAnimator;)V
...
.method private handlePauseButtonClick()V
    ...
    iget-object v0, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    iget-object v0, v0, Lp4/h0;->a:Landroid/widget/ImageButton;
...
.method public static synthetic i(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/animation/ValueAnimator;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$setWidgetViewScaleAnimator$13(Landroid/animation/ValueAnimator;)V
...
.method private initView(Landroid/content/Context;)V
    ...
    invoke-static {p1, p0, v0}, Lp4/h0;->d(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Z)Lp4/h0;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    return-void
.end method

.method public static synthetic j(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$saveLatestThumbnail$6(Landroid/graphics/Bitmap;)V
...
.method public static synthetic k(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$setWidgetErrorTranslateAnimator$12(Landroid/animation/ValueAnimator;)V

    return-void
.end method

.method public static synthetic l(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$updateQuickViewThumbnail$11()V
...
.method private static synthetic lambda$cancelAllAnimation$1(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V
    ...
    invoke-static {p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;->b(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V
...
.method private synthetic lambda$new$0(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p0, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    iget-object p0, p0, Lp4/h0;->d:Landroid/widget/ImageView;
...
.method private synthetic lambda$onQuickViewThumbnailLoaded$5(Landroid/graphics/Bitmap;ZLandroidx/dynamicanimation/animation/DynamicAnimation;ZFF)V
    .locals 0
...
.method private synthetic lambda$saveLatestThumbnail$6(Landroid/graphics/Bitmap;)V
    .locals 0
...
.method private synthetic lambda$setWidgetErrorTranslateAnimator$12(Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private synthetic lambda$setWidgetViewScaleAnimator$13(Landroid/animation/ValueAnimator;)V
    .locals 2

    iget-object v0, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    iget-object v0, v0, Lp4/h0;->g:Landroid/widget/ImageView;
    ...
    iget-object v0, v0, Lp4/h0;->f:Landroid/widget/TextView;
...
.method private static synthetic lambda$startQuickViewAlphaAnimation$14(Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private static synthetic lambda$startQuickViewThumbnailScaleDownAnimation$7(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V
    .locals 0
...
.method private synthetic lambda$startQuickViewTranslationAnimation$15(Landroid/graphics/Bitmap;Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 1
...
.method private synthetic lambda$startWidgetViewAnimation$8(Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private static synthetic lambda$updateButton$9(Landroid/view/View;Landroid/view/View;Landroid/animation/ValueAnimator;)V
    .locals 0
...
.method private synthetic lambda$updateQuickViewThumbnail$10(Landroid/graphics/Bitmap;I)V
    .locals 0
...
.method private synthetic lambda$updateQuickViewThumbnail$11()V
    .locals 0
...
.method public static synthetic m(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V
    .locals 0

    invoke-static {p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$startQuickViewThumbnailScaleDownAnimation$7(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)V

    return-void
.end method

.method public static synthetic n(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;ZLandroidx/dynamicanimation/animation/DynamicAnimation;ZFF)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$onQuickViewThumbnailLoaded$5(Landroid/graphics/Bitmap;ZLandroidx/dynamicanimation/animation/DynamicAnimation;ZFF)V

    return-void
.end method

.method public static synthetic o(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$updateQuickViewThumbnail$10(Landroid/graphics/Bitmap;I)V
...
.method public static synthetic p(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$startWidgetViewAnimation$8(Landroid/animation/ValueAnimator;)V

    return-void
.end method

.method public static synthetic q(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic r(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/view/View;Landroid/view/MotionEvent;)Z
    .locals 0
...
.method public static synthetic s(Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->lambda$startQuickViewAlphaAnimation$14(Landroid/widget/ImageView;Landroid/animation/ValueAnimator;)V
...
.method private setWidgetErrorTranslateAnimator(FF)Landroid/animation/ValueAnimator;
    ...
    new-instance p2, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/j;

    invoke-direct {p2, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/j;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method private setWidgetViewScaleAnimator(FFI)Landroid/animation/ValueAnimator;
    ...
    new-instance p2, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/f;

    invoke-direct {p2, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/f;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method private startQuickViewTranslationAnimation(ILandroid/graphics/Bitmap;)V
    ...
    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/r;

    invoke-direct {v1, p0, p2, p1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/r;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;Landroid/widget/ImageView;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    new-instance p1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$7;

    invoke-direct {p1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$7;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method private startWidgetViewErrorAnimation()V
    ...
    invoke-direct {p0, v4, v2}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->setWidgetErrorTranslateAnimator(FF)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {p0, v2, v3}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->setWidgetErrorTranslateAnimator(FF)Landroid/animation/ValueAnimator;
...
.method public static bridge synthetic t(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)Z
    .locals 0
...
.method public static bridge synthetic u(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;
    .locals 0
...
.method private updateThumbnailBitmap(Landroid/widget/ImageView;Landroid/graphics/Bitmap;)V
    ...
    iget-object p0, p0, Lp4/h0;->e:Landroid/widget/ImageView;
...
.method public static bridge synthetic v(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)Lp4/h0;
    .locals 0
...
.method public static bridge synthetic w(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mIsWidgetErrorAnimationRequested:Z

    return-void
.end method

.method public static bridge synthetic x(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;I)V
    .locals 0
...
.method public static bridge synthetic y(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    .locals 0
...
.method public cancelAllAnimation()V
    ...
    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/h;

    invoke-direct {v1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/h;-><init>()V
...
.method public getBackgroundView()Landroid/view/View;
    ...
    iget-object p0, p0, Lp4/h0;->b:Landroid/widget/ImageView;
...
.method public getForegroundView()Landroid/view/View;
    ...
    iget-object p0, p0, Lp4/h0;->a:Landroid/widget/ImageButton;
...
.method public initialize()V
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    iget-object v2, v2, Lp4/h0;->c:Landroid/widget/FrameLayout;
    ...
    new-instance v3, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/l;

    invoke-direct {v3, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/l;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    ...
    invoke-virtual {v0, v1}, Lp4/h0;->g(Ljava/lang/Boolean;)V

    iget-object v0, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    invoke-virtual {v0}, Lp4/h0;->c()Ljava/lang/Boolean;
    ...
    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/m;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/m;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    ...
    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/n;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
    ...
    iget-object v0, v0, Lp4/h0;->c:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;->mViewBinding:Lp4/h0;

    iget-object v1, v1, Lp4/h0;->c:Landroid/widget/FrameLayout;
    ...
    invoke-virtual {v0, v1}, Lp4/h0;->f(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonContract$Presenter;)V
...
.method public onQuickViewThumbnailEmpty()V
    ...
    iget-object v0, v0, Lp4/h0;->e:Landroid/widget/ImageView;
...
.method public onQuickViewThumbnailLoaded(Landroid/graphics/Bitmap;Z)V
    ...
    invoke-static {v0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;->c(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;)Z
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/e;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/graphics/Bitmap;Z)V

    invoke-static {v0, v1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;->a(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;Landroidx/dynamicanimation/animation/DynamicAnimation$OnAnimationEndListener;)V
...
.method public saveLatestThumbnail()V
    ...
    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/o;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/o;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method public setToolTipText(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lp4/h0;->c:Landroid/widget/FrameLayout;
...
.method public startQuickViewThumbnailScaleDownAnimation()V
    ...
    new-instance v1, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/i;

    invoke-direct {v1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/i;-><init>()V
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$SpringAnimationHolder;-><init>(Landroid/view/View;Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/t;)V
...
.method public startWidgetViewAnimation()V
    ...
    new-instance v2, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/k;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/k;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
...
.method public updateButton(Lcom/sec/android/app/camera/interfaces/KeyScreenLayerManager$CenterButtonState;)V
    ...
    sget-object v0, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$8;->$SwitchMap$com$sec$android$app$camera$interfaces$KeyScreenLayerManager$CenterButtonState:[I
    ...
    iget-object v1, v0, Lp4/h0;->a:Landroid/widget/ImageButton;

    iget-object v4, v0, Lp4/h0;->c:Landroid/widget/FrameLayout;
    ...
    iget-object v1, v0, Lp4/h0;->c:Landroid/widget/FrameLayout;

    iget-object v4, v0, Lp4/h0;->a:Landroid/widget/ImageButton;
    ...
    invoke-direct {v0, v1, v4}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/g;-><init>(Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v0, p0, v4, v1}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView$4;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;Landroid/view/View;Landroid/view/View;)V
...
.method public updateQuickViewThumbnail(Landroid/graphics/Bitmap;I)V
    ...
    invoke-direct {p1, p0}, Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/p;-><init>(Lcom/sec/android/app/camera/layer/keyscreen/sidebutton/LeftButtonView;)V
