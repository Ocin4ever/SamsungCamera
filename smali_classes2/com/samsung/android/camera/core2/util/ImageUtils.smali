...
.method public static allocateByteBuffer([BLcom/samsung/android/camera/core2/util/ImageInfo;Landroid/util/Size;)[B
    ...
    invoke-static {p2, p0}, Lcom/samsung/android/camera/core2/util/ImageUtils;->getNV21BufferSize(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/StrideInfo;)I
...
.method public static allocateImageBuffer(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/util/ImageInfo;Landroid/util/Size;)Lcom/samsung/android/camera/core2/util/ImageBuffer;
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/camera/core2/util/ImageBuffer;->b(ILcom/samsung/android/camera/core2/util/ImageInfo;)Lcom/samsung/android/camera/core2/util/ImageBuffer;
...
.method public static synthetic b(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/ImageInfo;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/android/camera/core2/util/ImageUtils;->lambda$convertNV21ToPackedNV21$1(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/ImageInfo;)V
...
.method public static convertFlexibleYuvToPackedNV21(Landroid/media/Image;Lcom/samsung/android/camera/core2/util/ImageBuffer;)Z
    .locals 10
    ...
    invoke-static {p1, p0, v0}, Lcom/samsung/android/camera/core2/util/CLog;->h(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static/range {v4 .. v9}, Lcom/samsung/android/camera/core2/util/ImageUtils;->nativeConvertFlexibleYuvToPackedNV21([Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II[I[I)I
    ...
    invoke-static {p0, v0, p1}, Lcom/samsung/android/camera/core2/util/CLog;->h(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p0, v1}, Lcom/samsung/android/camera/core2/util/ImageBuffer;->j(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    invoke-static {v2, p0, v3}, Lcom/samsung/android/camera/core2/util/CLog;->h(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static convertNV21ToPackedNV21(Lcom/samsung/android/camera/core2/util/ImageBuffer;Lcom/samsung/android/camera/core2/util/ImageBuffer;)Z
    ...
    const-string v0, "convertNV21ToPackedNV21 - source format(%s) is not YUV_420_888"
    ...
    :cond_5
    new-instance p0, Lcom/samsung/android/camera/core2/util/s0;

    invoke-direct {p0, v3}, Lcom/samsung/android/camera/core2/util/s0;-><init>(Landroid/util/Size;)V

    invoke-static {v2, p0}, Lcom/samsung/android/camera/core2/util/ImageInfo;->g(Lcom/samsung/android/camera/core2/util/ImageInfo;Ljava/util/function/Consumer;)Lcom/samsung/android/camera/core2/util/ImageInfo;
...
.method public static convertPackedNV21ToRGBA(Lcom/samsung/android/camera/core2/util/DirectBuffer;Lcom/samsung/android/camera/core2/util/DirectBuffer;IIZ)Z
    ...
    invoke-static {v0, v3, p2, p3, p4}, Lcom/samsung/android/camera/core2/util/ImageUtils;->nativeConvertPackedNV21ToRGBA(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IIZ)I
    ...
    invoke-static {p2, p0, p3}, Lcom/samsung/android/camera/core2/util/CLog;->h(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static convertPackedNV21ToRGBA_Partial(Lcom/samsung/android/camera/core2/util/DirectBuffer;Lcom/samsung/android/camera/core2/util/DirectBuffer;IIIIIZII)Z
    ...
    invoke-virtual {v0, v2}, Lcom/samsung/android/camera/core2/util/DirectBuffer;->returnByteBuffer(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v5, v0, v2}, Lcom/samsung/android/camera/core2/util/CLog;->h(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public static extractThumbnailFromHeic(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Lcom/samsung/android/camera/core2/util/ImageUtils$SimpleImage;
    ...
    sget-object v0, Lcom/samsung/android/camera/core2/util/SemImageFormat;->y:Lcom/samsung/android/camera/core2/util/SemImageFormat;
    ...
    const-string v4, "extractThumbnailFromHeic is failed : "
...
.method public static extractThumbnailFromJpeg(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Lcom/samsung/android/camera/core2/util/ImageUtils$SimpleImage;
    ...
    invoke-static {p0, v4}, Lcom/samsung/android/camera/core2/local/vendorkey/SemCaptureResult;->b(Lcom/samsung/android/camera/core2/metadata/CaptureMetadata;Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    const-string v6, "extractThumbnailFromJpeg - size info of jpeg Exif is null ("
    ...
    const-string v2, "), so get from CaptureMetadata : "
    ...
    invoke-static {v4, v2}, Lcom/samsung/android/camera/core2/util/CLog;->t(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    :try_end_2
    ...
    const-string v5, "Could not read exif tags from : "
    ...
    invoke-static {v3, p0}, Lcom/samsung/android/camera/core2/util/CLog;->f(Lcom/samsung/android/camera/core2/util/CLog$Tag;Ljava/lang/String;)V
    ...
    const-string v2, "there is no JPEG compressed thumbnail"
    ...
    invoke-direct {v1, v0, v2, p0}, Lcom/samsung/android/camera/core2/util/ImageUtils$SimpleImage;-><init>(Ljava/nio/ByteBuffer;Lcom/samsung/android/camera/core2/util/SemImageFormat;Landroid/util/Size;)V
...
.method public static getCaptureDateTime(Lcom/samsung/android/camera/core2/metadata/CaptureMetadata;Lcom/samsung/android/camera/core2/ExtraBundle;)Lcom/samsung/android/camera/core2/util/ImageUtils$CaptureDateTime;
    ...
    new-instance p1, Lcom/samsung/android/camera/core2/util/t0;
    ...
    invoke-direct {v2, v0, p0}, Lcom/samsung/android/camera/core2/util/ImageUtils$CaptureDateTime;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static getExifSubSecTime(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Ljava/lang/String;
    ...
    const-string v1, "there is no sub_sec_time tags"
...
.method public static getNV21BufferSize(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/StrideInfo;)I
    .locals 1
    ...
    invoke-static {v0, p0, p1}, Lcom/samsung/android/camera/core2/util/ImageUtils;->getNV21BufferSize(IILcom/samsung/android/camera/core2/util/StrideInfo;)I
...
.method public static getPaddedNV21BufferSize(Landroid/util/Size;)I
    ...
    invoke-static {v0, v1}, Lcom/samsung/android/camera/core2/util/CalculationUtils;->b(II)I
    ...
    invoke-static {v2, v1}, Lcom/samsung/android/camera/core2/util/CalculationUtils;->b(II)I

    move-result v1

    new-instance v2, Lcom/samsung/android/camera/core2/util/StrideInfo;

    invoke-direct {v2, p0, v0, v1}, Lcom/samsung/android/camera/core2/util/StrideInfo;-><init>(Landroid/util/Size;II)V

    invoke-static {p0, v2}, Lcom/samsung/android/camera/core2/util/ImageUtils;->getNV21BufferSize(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/StrideInfo;)I
...
.method public static isValidEncodedBuffer(Lcom/samsung/android/camera/core2/util/ImageBuffer;)Z
    ...
    invoke-virtual {v1}, Lcom/samsung/android/camera/core2/util/SemImageFormat;->t()I
...
.method private static synthetic lambda$convertNV21ToPackedNV21$1(Landroid/util/Size;Lcom/samsung/android/camera/core2/util/ImageInfo;)V
    .locals 1
...
.method public static makeBitmap([B)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, v5, v4, v2}, Landroid/graphics/BitmapFactory;->decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public static varargs quramResizeNV21ToPackedNV21(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IIIIII[Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;)Z
    ...
    :cond_4
    invoke-static {}, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->m()Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    move-result-object v0

    :goto_0
    invoke-virtual {v0}, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->o()I
