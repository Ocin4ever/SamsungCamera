...
.method public detectBlock(Landroid/graphics/Bitmap;Landroid/graphics/Point;[Landroid/graphics/Point;)Z
    ...
    const-string v0, "Use MOCR::detectBlock_ARGB_bmp"
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/samsung/android/ocr/MOCR;->detectBlock_ARGB_bmp(Landroid/graphics/Bitmap;Landroid/graphics/Point;[Landroid/graphics/Point;)I
    ...
    const-string p2, "MOCRecognizer::detectBlock_ARGB_bmp() MOCR(detect_ARGB_bmp) is Failed! ErrorCode : "
...
.method public recognizeBlockAt(Landroid/graphics/Bitmap;Landroid/graphics/Point;ZLcom/samsung/android/sdk/ocr/OCRResult;)Z
    ...
    const-string v0, "MOCRecognizer::recognizeBlock_ARGB() Used to MOCR library"
    ...
    const-string p3, "recognizeBlock_ARGB_bmp(..) is not supported in case of forceToSelectAny==false"

    invoke-static {v1, p3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    new-instance p3, Lcom/samsung/android/ocr/MOCRResult$Page;

    invoke-direct {p3}, Lcom/samsung/android/ocr/MOCRResult$Page;-><init>()V

    iget-object p0, p0, Lcom/samsung/android/sdk/ocr/MOCRecognizer;->mocr:Lcom/samsung/android/ocr/MOCR;

    invoke-virtual {p0, p1, p2, p3}, Lcom/samsung/android/ocr/MOCR;->recognizeBlock_ARGB_bmp(Landroid/graphics/Bitmap;Landroid/graphics/Point;Lcom/samsung/android/ocr/MOCRResult$Page;)I

    move-result p0

    if-nez p0, :cond_1

    invoke-static {p3, p4}, Lcom/samsung/android/sdk/ocr/MOCRConverter;->convertPage(Lcom/samsung/android/ocr/MOCRResult$Page;Lcom/samsung/android/sdk/ocr/OCRResult;)Lcom/samsung/android/sdk/ocr/OCRResult;
    ...
    const-string p2, "MOCRecognizer::recognizeBlock_ARGB() is Failed! ErrorCode : "
