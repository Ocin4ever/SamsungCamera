...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/livetranslation/text/KeyFrame;Landroid/graphics/Rect;Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager$LiveTranslationTaskManagerListener;Ljava/lang/String;Z)V
    ...
    const-class v0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->TAG:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mSTRTasks:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mPostSTRTasks:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mPostTRLTasks:Ljava/util/List;
    ...
    iput-object p3, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mROIinLandscapeAxis:Landroid/graphics/Rect;
    ...
    iput-object p5, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mLaunchModeName:Ljava/lang/String;

    iput-boolean p6, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mIsPreviewMode:Z
...
.method private declared-synchronized requestTask(Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/livetranslation/task/LiveTranslationTask$TASKTYPE;Lcom/samsung/android/livetranslation/data/LttOcrResult;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v2, "requestTask() : srcLang="
    ...
    const-string p3, "Unexpected CP : STR_CP="
...
.method private declared-synchronized updateStatus(Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager$STATUS;)V
    ...
    iget-object v1, p0, Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager;->mStatus:Lcom/samsung/android/livetranslation/task/LiveTranslationTaskManager$STATUS;
    ...
    const-string v2, "updateStatus() But current Status is STATUS.CANCELED , It can NOT change to newStatus:"
    ...
    invoke-static {v0, p1}, Lcom/samsung/android/livetranslation/util/LTTLogger;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public requestTask(Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/livetranslation/task/LiveTranslationTask$TASKTYPE;Lcom/samsung/android/livetranslation/data/LttOcrResult;)V
    .locals 6
