...
.method public static synthetic b(Landroid/widget/LinearLayout;Ljava/util/ArrayList;)V
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/app/AlertController;->lambda$seslExpandTouchTarget$0(Landroid/widget/LinearLayout;Ljava/util/ArrayList;)V
...
.method private static synthetic lambda$seslExpandTouchTarget$0(Landroid/widget/LinearLayout;Ljava/util/ArrayList;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/core/view/SeslTouchDelegateFactory;->make(Landroid/widget/LinearLayout;Ljava/util/List;)Landroidx/core/view/SeslTouchTargetDelegate$Builder;
...
.method private seslExpandTouchTarget(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, p0, p1}, Landroidx/appcompat/app/a;-><init>(Landroid/widget/LinearLayout;Ljava/util/ArrayList;)V
...
.method private setupButtons(Landroid/view/ViewGroup;)V
    ...
    iget v10, p0, Landroidx/appcompat/app/AlertController;->mButtonIconDimen:I

    invoke-virtual {v7, v2, v2, v10, v10}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v7, p0, Landroidx/appcompat/app/AlertController;->mButtonPositive:Landroid/widget/Button;

    iget-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonPositiveIcon:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v7, v10, v9, v9, v9}, Landroid/widget/TextView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonNegative:Landroid/widget/Button;

    iget-object v11, p0, Landroidx/appcompat/app/AlertController;->mButtonHandler:Landroid/view/View$OnClickListener;

    invoke-virtual {v10, v11}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    if-eqz v5, :cond_8

    iget-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonNegative:Landroid/widget/Button;
    ...
    invoke-static {v10, v0, v4}, Landroidx/reflect/widget/SeslTextViewReflector;->semSetButtonShapeEnabled(Landroid/widget/TextView;ZI)V
    ...
    invoke-static {v10, v0}, Landroidx/reflect/widget/SeslTextViewReflector;->semSetButtonShapeEnabled(Landroid/widget/TextView;Z)V
    ...
    iget-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonNegativeIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, v2, v2, v11, v11}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonNegative:Landroid/widget/Button;

    iget-object v11, p0, Landroidx/appcompat/app/AlertController;->mButtonNegativeIcon:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v10, v11, v9, v9, v9}, Landroid/widget/TextView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object v10, p0, Landroidx/appcompat/app/AlertController;->mButtonNeutral:Landroid/widget/Button;
    ...
    invoke-virtual {v0, v3, v9, v9, v9}, Landroid/widget/TextView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private setupView()V
    ...
    invoke-direct {v6, p0}, Landroidx/appcompat/app/b;-><init>(Landroidx/appcompat/app/AlertController;)V
    ...
    :goto_0
    iput-object v6, p0, Landroidx/appcompat/app/AlertController;->mDefaultButtonPanelJob:Landroidx/core/util/Consumer;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/widget/AbsListView;->setSelectionFromTop(II)V
