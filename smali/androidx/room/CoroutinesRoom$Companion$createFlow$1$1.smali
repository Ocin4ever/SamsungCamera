...
# instance fields
.field final synthetic $$this$flow:La7/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "La7/f;"
        }
...
# direct methods
.method public constructor <init>(ZLandroidx/room/RoomDatabase;La7/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Li6/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:La7/f;
    ...
    invoke-direct {p0, p1, p6}, Lk6/l;-><init>(ILi6/d;)V
...
.method public final create(Ljava/lang/Object;Li6/d;)Li6/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:La7/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;-><init>(ZLandroidx/room/RoomDatabase;La7/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Li6/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->invoke(Lx6/h0;Li6/d;)Ljava/lang/Object;
...
.method public final invoke(Lx6/h0;Li6/d;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->create(Ljava/lang/Object;Li6/d;)Li6/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p1, v4, v4, v1, v4}, Lz6/g;->b(ILz6/a;Lq6/l;ILjava/lang/Object;)Lz6/d;
    ...
    invoke-direct {v7, p1, v8}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;-><init>([Ljava/lang/String;Lz6/d;)V

    sget-object p1, Lf6/p;->a:Lf6/p;

    invoke-interface {v8, p1}, Lz6/t;->p(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-interface {v3}, Lx6/h0;->getCoroutineContext()Li6/g;

    move-result-object p1

    sget-object v1, Landroidx/room/TransactionElement;->Key:Landroidx/room/TransactionElement$Key;

    invoke-interface {p1, v1}, Li6/g;->get(Li6/g$c;)Li6/g$b;
    ...
    invoke-virtual {p1}, Landroidx/room/TransactionElement;->getTransactionDispatcher$room_ktx_release()Li6/e;
    ...
    invoke-static {v1, v4, v4, v5, v4}, Lz6/g;->b(ILz6/a;Lq6/l;ILjava/lang/Object;)Lz6/d;
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Lz6/d;Ljava/util/concurrent/Callable;Lz6/d;Li6/d;)V
    ...
    invoke-static/range {v3 .. v8}, Lx6/g;->d(Lx6/h0;Li6/g;Lx6/j0;Lq6/p;ILjava/lang/Object;)Lx6/r1;

    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:La7/f;

    iput v2, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->label:I

    invoke-static {p1, v1, p0}, La7/g;->d(La7/f;Lz6/s;Li6/d;)Ljava/lang/Object;
