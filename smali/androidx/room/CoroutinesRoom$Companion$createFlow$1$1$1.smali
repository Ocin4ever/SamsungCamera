...
.field final synthetic $observerChannel:Lz6/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz6/d;"
        }
...
.field final synthetic $resultChannel:Lz6/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lz6/d;"
        }
...
# direct methods
.method public constructor <init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Lz6/d;Ljava/util/concurrent/Callable;Lz6/d;Li6/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lz6/d;

    iput-object p4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$callable:Ljava/util/concurrent/Callable;

    iput-object p5, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lz6/d;
...
.method public final create(Ljava/lang/Object;Li6/d;)Li6/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lz6/d;

    iget-object v4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$callable:Ljava/util/concurrent/Callable;

    iget-object v5, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lz6/d;

    move-object v0, p1

    move-object v6, p2

    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Lz6/d;Ljava/util/concurrent/Callable;Lz6/d;Li6/d;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->invoke(Lx6/h0;Li6/d;)Ljava/lang/Object;
...
.method public final invoke(Lx6/h0;Li6/d;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->create(Ljava/lang/Object;Li6/d;)Li6/d;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$observerChannel:Lz6/d;
    ...
    invoke-interface {p1, p0}, Lz6/f;->b(Li6/d;)Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lz6/f;->next()Ljava/lang/Object;
    ...
    iget-object v4, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;->$resultChannel:Lz6/d;
    ...
    invoke-interface {v4, p1, p0}, Lz6/t;->d(Ljava/lang/Object;Li6/d;)Ljava/lang/Object;
