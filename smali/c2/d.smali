...
.method public bridge synthetic b(Lg2/a;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lc2/d;->f(Lg2/a;)Ljava/util/Date;
...
.method public bridge synthetic d(Lg2/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lc2/d;->g(Lg2/c;Ljava/util/Date;)V

    return-void
.end method

.method public final e(Lg2/a;)Ljava/util/Date;
    .locals 4
    ...
    iget-object v1, p0, Lc2/d;->b:Ljava/util/List;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lc2/d;->b:Ljava/util/List;
    ...
    invoke-static {v0, p0}, Ld2/a;->c(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
...
.method public f(Lg2/a;)Ljava/util/Date;
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lc2/d;->e(Lg2/a;)Ljava/util/Date;

    move-result-object p1

    iget-object p0, p0, Lc2/d;->a:Lc2/d$b;

    invoke-virtual {p0, p1}, Lc2/d$b;->d(Ljava/util/Date;)Ljava/util/Date;
...
.method public g(Lg2/c;Ljava/util/Date;)V
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lc2/d;->b:Ljava/util/List;
