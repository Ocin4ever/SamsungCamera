...
.method public static bridge synthetic e(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;)I
    .locals 0
...
.method public static bridge synthetic f(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;Landroid/graphics/Bitmap;)V
    .locals 0
...
.method public static bridge synthetic g(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;IIIII)Landroid/graphics/Matrix;
    .locals 0
...
.method public static bridge synthetic h(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;)Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter$QrDetectionState;
    .locals 0
...
.method private handleLinkAction(La5/m0;Lk2/u;Z)V
    .locals 5
    ...
    :try_start_0
    invoke-static {v0, p1, p2}, La5/e0;->w(Landroid/content/Context;La5/m0;Lk2/u;)V

    goto :goto_0

    :cond_0
    invoke-static {v0, p1, p2}, La5/e0;->L(Landroid/content/Context;La5/m0;Lk2/u;)Landroid/content/Intent;
...
.method private handleQrCodeDetected(Ljava/lang/String;[ILandroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    invoke-static {v0, p1}, La5/s2;->A(Landroid/content/Context;Ljava/lang/String;)La5/r0;

    move-result-object p1

    iput-object p1, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:La5/r0;
    ...
    invoke-virtual {p1}, La5/r0;->m()Lcom/sec/android/app/camera/interfaces/SaLogDetail;
    ...
    iget-object p0, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:La5/r0;
...
.method private handleRequestedScanAction(Ljava/lang/String;La5/r0;)V
    .locals 2
    ...
    invoke-virtual {p2}, La5/r0;->p()La5/u2;
    ...
    invoke-static {p1}, La5/q0;->r(Ljava/lang/String;)La5/q0;
    ...
    invoke-virtual {p1, p2}, La5/q0;->t(La5/u2;)La5/m0;
    ...
    :cond_0
    iget-object p2, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:La5/r0;

    invoke-virtual {p2}, La5/r0;->l()Lk2/u;

    move-result-object p2

    const/4 v0, 0x0

    invoke-direct {p0, p1, p2, v0}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleLinkAction(La5/m0;Lk2/u;Z)V
...
.method public static bridge synthetic i(Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;Ljava/lang/String;[ILandroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    .locals 0
...
.method public onGalleryButtonClicked()V
    ...
    invoke-interface {v0}, Lcom/sec/android/app/camera/shootingmode/qr/QrContract$View;->showBlackBackground()V
    :try_end_0
...
.method public onQrDetectAnimationFinished()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:La5/r0;

    invoke-direct {p0, v0, v1}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleRequestedScanAction(Ljava/lang/String;La5/r0;)V

    return-void

    :cond_1
    iget-object v0, p0, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->mQrCodeResult:La5/r0;

    invoke-virtual {v0}, La5/r0;->q()Z
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/sec/android/app/camera/shootingmode/qr/QrPresenter;->handleLinkAction(La5/m0;Lk2/u;Z)V
