...
.implements Lcom/sec/android/app/camera/interfaces/CallbackManager$SingleBokehEventListener;
...
.method private createManagers()V
    ...
    invoke-direct {v0, v1, v2}, Lcom/sec/android/app/camera/shootingmode/common/manager/NightSceneInfoCallbackManager;-><init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/interfaces/Engine;)V
...
.method public static synthetic e(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    .locals 0
...
.method private enableEngineCallbacks(Z)V
    ...
    invoke-interface {v0}, Lcom/sec/android/app/camera/interfaces/Capability;->isSingleBokehInHalSupported()Z
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/camera/interfaces/CallbackManager;->enableBokehInfoCallback(Z)V
    ...
    invoke-interface {p0, p1}, Lcom/sec/android/app/camera/interfaces/CallbackManager;->enableSingleBokehEventCallback(Z)V
...
.method private enableEngineEventListeners(Z)V
    ...
    :goto_5
    invoke-interface {v0, v2}, Lcom/sec/android/app/camera/interfaces/CallbackManager;->setSingleBokehEventListener(Lcom/sec/android/app/camera/interfaces/CallbackManager$SingleBokehEventListener;)V
...
.method private getBokehEffectItemPosition()I
    ...
    invoke-virtual {v2}, Lo4/b;->a()Lcom/sec/android/app/camera/interfaces/CommandId;

    move-result-object v3

    invoke-static {v3}, Ln4/g0;->d(Lcom/sec/android/app/camera/interfaces/CommandId;)I
...
.method public static synthetic i(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    .locals 0
...
.method private initializeBokehEffect()V
    ...
    invoke-static {v0, v3}, Ln4/g0;->b(Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;I)Lcom/sec/android/app/camera/interfaces/CommandId;
...
.method private initializeVisibilityChangeConsumerMap()Ljava/util/EnumMap;
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/v0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/v0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/w0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/w0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/x0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/x0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/y0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/y0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/z0;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/z0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/a1;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/a1;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/b1;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/b1;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
...
.method public static synthetic n(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;Ljava/util/HashMap;Lcom/sec/android/app/camera/interfaces/SaLogEventKey;)V
    .locals 0
...
.method private updateGuide(Lcom/sec/android/app/camera/util/BokehUtil$BokehCallbackState;)V
    ...
    invoke-direct {p0, v2}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->updateGuideVisibility(Z)V
    ...
    iput-boolean v1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsGuideToastTimerExpired:Z
...
.method public handlePictureSaved()V
    ...
    invoke-virtual {v0}, Lcom/sec/android/app/camera/shootingmode/common/manager/NightSceneInfoCallbackManager;->updateDetectedScene()V
...
.method public injectMock(Lcom/sec/android/app/camera/shootingmode/common/manager/SceneDetectionCallbackManager;Lcom/sec/android/app/camera/shootingmode/common/manager/NightSceneInfoCallbackManager;Lcom/sec/android/app/camera/shootingmode/common/nightscreenflash/NightScreenFlashContract$Presenter;Lcom/sec/android/app/camera/shootingmode/common/nightscreenflash/NightScreenFlashController;)V
    .locals 0
...
.method public onCaptureEvent(Lcom/sec/android/app/camera/shootingmode/abstraction/AbstractShootingModePresenter$CaptureEvent;)V
    ...
    invoke-direct {p0, v1, v0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->updateNightModeButton(ZZ)V
    ...
    iput-boolean v1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsNightCapturing:Z
...
.method public onInactivate()V
    ...
    invoke-interface {v1}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->hideBokehBeautyMenuText()V
...
.method public onStartPreviewCompleted()V
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->setSuperNightMode(Z)V
...
.method public onStartPreviewPrepared(ILcom/sec/android/app/camera/interfaces/Capability;Lcom/sec/android/app/camera/interfaces/Engine$MakerSettings;)V
    ...
    sget-object p2, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->SELFIE_TONE_V3_MODE:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    sget-object p2, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->SELFIE_TONE_V2_MODE:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    sget-object p2, Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;->SELFIE_TONE_MODE:Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    :goto_0
    sget-object p2, Lcom/samsung/android/camera/core2/MakerPublicKey;->h0:Landroid/hardware/camera2/CaptureRequest$Key;

    invoke-static {p1}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-interface {p3, p2, v0}, Lcom/sec/android/app/camera/interfaces/Engine$MakerSettings;->equals(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)Z
    ...
    invoke-interface {p3, p2, p1}, Lcom/sec/android/app/camera/interfaces/Engine$MakerSettings;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
...
.method public onVisibilityChanged(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    new-instance v0, Lcom/sec/android/app/camera/shootingmode/portrait/d1;

    invoke-direct {v0, p1, p2}, Lcom/sec/android/app/camera/shootingmode/portrait/d1;-><init>(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
...
.method public updateCaptureEventLog(Ljava/util/HashMap;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/shootingmode/portrait/u0;

    invoke-direct {v2, p0, p1}, Lcom/sec/android/app/camera/shootingmode/portrait/u0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;Ljava/util/HashMap;)V
    ...
    iget-boolean v1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsNightCapturing:Z
