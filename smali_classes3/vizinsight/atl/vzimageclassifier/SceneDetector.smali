...
.method public initilize()V
    ...
    const-string v0, "Initialization of SceneDetector started"
    ...
    iget-boolean v0, v0, Lvizinsight/atl/vzimageclassifier/SceneDetectorDestroyer;->isRunning:Z
    ...
    :try_start_0
    const-string v0, "Joining release thread for completion"
    ...
    invoke-virtual {v0}, Lvizinsight/atl/vzimageclassifier/SceneDetectorDestroyer;->join()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    const-string v0, "release thread was not-started/completed"
    ...
    new-instance v0, Lvizinsight/atl/vzimageclassifier/VZClassifier;

    invoke-direct {v0}, Lvizinsight/atl/vzimageclassifier/VZClassifier;-><init>()V

    iput-object v0, p0, Lvizinsight/atl/vzimageclassifier/SceneDetector;->mVZclsJNI:Lvizinsight/atl/vzimageclassifier/VZClassifier;
    ...
    invoke-virtual {v0, v2, v3}, Lvizinsight/atl/vzimageclassifier/VZClassifier;->initialize(Ljava/lang/String;I)V
